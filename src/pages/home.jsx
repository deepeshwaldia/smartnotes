...
style={{
              ...
              Genrete exam-focused notes,project documentatio ,flow diagrams and revision-ready content using AI - faster ,cleaner  and smarter.
...
className="transform-gpu"
style={{transformStyle:"preserve-3d"}}>
<div className='overflow-hidden '><img src={img} alt="img" style={{transform:"translateZ(35px)" }}/></div>
</motion.div>
    </section>
    {/* bottom */}
