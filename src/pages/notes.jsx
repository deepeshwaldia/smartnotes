  ...
  return (
    <div className='min-h-screen bg-linear-to-br from-gray-100 to-gray-200 px-6 py-8'>
      <motion.header 
        ...
        className=' mb-10  rounded-2xl bg-black/80 backdrop-blur-xl border border-white/10 px-8 py-6 shadow-[0_20px_45px_rgba(0,0,0,0.6)] flex md:items-center justify-between flex-col md:flex-row gap-4'>
        ...
        {loading && (
          ...
          className='text-center text-black font-medium mb-6'>Generate exam-focused notes...</motion.div>
        )}
        {error && (
