...
const Sidebar = ({ result }) => {
  ...
  if (!result || !result.subTopics
   || !result.questions || !result.questions.short || !result.questions.long
  ) {
    return null
  }

  return (
    <div className='bg-white rounded-2xl border border-gray-200 shadow-sm p-5 space-y-6 min-h-[220px]'>
...
<span className='text-yellow-700 font-bold text-sm '>{result.importance}</span>
      ...
      <p className='text-sm font-semibold text-gray-700 mb-3 mt-2'> Important Question</p>
